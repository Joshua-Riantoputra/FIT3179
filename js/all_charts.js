...
// vegaEmbed('#bar', "js/stacked_bar.vg.json", {actions: false}).then(function(result) {}).catch(console.error);
vegaEmbed('#sankey', "js/example_sankey.vg.json", {renderer: 'svg', actions: false}).then(function(result) {}).catch(console.error);